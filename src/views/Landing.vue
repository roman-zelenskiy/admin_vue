...
<template>
	...
	<div id="header" class="app-header navbar navbar-expand-lg p-0">
		<div class="container-xxl px-3 px-lg-5">
			...
			<RouterLink to="/" class="navbar-brand d-flex align-items-center position-relative me-auto">
			...
			<div class="ms-3">
				<RouterLink to="/" class="btn btn-theme fw-bold rounded-pill px-3 py-2">Get started <i class="fa fa-arrow-right ms-2 opacity-5"></i></RouterLink>
			</div>
		</div>
	</div>
	<!-- END #header -->
			...
			<div class="div-hero-content z-3 position-relative">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="mb-2">
							<RouterLink to="/" class="btn btn-lg btn-theme px-3">Discover Our Template <i class="fa fa-arrow-right ms-2 opacity-5"></i></RouterLink>
						</div>
					...
					<div class="card border-0 rounded-4 h-100 bg-light">
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:usb-bold-duotone" class="display-6 text-gray-500" />
								</div>
							</div>
							<hr class="my-3">
					...
					<div class="card border-0 rounded-4 h-100 bg-light">
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:map-arrow-up-bold-duotone" class="display-6 text-gray-500" />
								</div>
							</div>
							<hr class="my-3">
							<div class="mb-5 text-body text-opacity-75 flex-1">
					...
					<div class="card border-0 rounded-4 shadow bg-gradient-blue-indigo text-white h-100"  data-bs-theme="dark">
						<div class="card-body fs-14px p-25px h-100 d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:cup-first-bold-duotone" class="display-5 text-white text-opacity-50" />
								</div>
							</div>
							<hr class="my-3">
					...
					<div class="card border-0 rounded-4 h-100 bg-light">
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:buildings-bold-duotone" class="display-6 text-gray-500" />
								</div>
							</div>
							<hr class="my-3">
							<div class="mb-5 text-body text-opacity-75 flex-1">
