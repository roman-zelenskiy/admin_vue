									...
									<div class="card-body">
										...
										<div class="d-flex align-items-center mb-3">
											...
											<div class="flex-fill ps-2">
												<div class="fw-500"><a href="#" class="text-decoration-none">Clyde Stanley</a> at <a href="#" class="text-decoration-none">South Lake Tahoe, California</a></div>
												<div class="text-body text-opacity-50 fs-13px">March 16</div>
											</div>
										</div>
						
										<!-- post content -->
										<p>Best vacation of 2022</p>
								...
								<div class="card mb-3">
									<div class="card-body pb-0">
										...
										<div class="d-flex align-items-center mb-3">
											<a href="#"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle"></a>
											<div class="flex-fill ps-2">
												<div class="fw-500"><a href="#" class="text-decoration-none">Clyde Stanley</a> is watching <a href="#" class="text-decoration-none">PATAGONIA 8k</a></div>
								...
								<div class="card mb-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center mb-3">
											...
											<div class="flex-fill ps-2">
												<div class="fw-500"><a href="#" class="text-decoration-none">Clyde Stanley</a></div>
								...
								<div class="card mb-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center mb-3">
											<a href="#"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle"></a>
											<div class="flex-fill ps-2">
												<div class="fw-500"><a href="#" class="text-decoration-none">Clyde Stanley</a> at <a href="#" class="text-decoration-none">United States</a></div>
