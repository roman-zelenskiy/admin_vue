...
const getCategories = async () => {
  const { categories: list, totalPages: total } =
    await categoriesStore.getCategoriesByFilters(page.value, {
  ...
  <div class="d-flex align-items-center mb-3">
    ...
    <div>
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active text-uppercase">Categories</li>
      </ul>
    ...
    <div class="ms-auto">
      <RouterLink to="/category-create" href="#" class="btn btn-theme"
        ><i class="fa fa-plus-circle fa-fw me-1"></i> Add Category</RouterLink
      >
    </div>
  </div>
