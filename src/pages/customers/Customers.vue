  ...
  <div class="d-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
      <RouterLink to="/customer-create" href="#" class="btn btn-theme"
        ><i class="fa fa-plus-circle fa-fw me-1"></i> Add Customer</RouterLink
      >
    </div>
  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Force Majeure White T Shirt</RouterLink
                      >
                    </div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Eco-friendly fashion, organic cotton, slow fashion polo
                        shirts</RouterLink
                      >
                    </div>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Nike Shoes (Red Color)</RouterLink
                      >
                    </div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Nike Air Max (Blue Color)</RouterLink
                      >
                    </div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Skate Sneaker (Orange Color)</RouterLink
                      >
                    </div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <RouterLink to="/page/product-details"
                        >Teen Fashion T-shirt (Black)</RouterLink
                      >
                    </div>
                  </div>
                </td>
