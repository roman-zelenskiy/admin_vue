    ...
    return {
      ...
      chart: {
        ...
        series: [
          {
            data: [
              8107, 8128, 8122, 8165, 8340, 8423, 8423, 8514, 8481, 8487, 8506,
              8626, 8668, 8602, 8607, 8512, 8496, 8600, 8881, 9340,
            ],
          },
        ],
  ...
  <div class="row">
    ...
    <div class="col-xl-6 mb-3">
      <card class="h-100 overflow-hidden">
        <card-img-overlay
          class="d-block d-lg-none bg-blue rounded"
        ></card-img-overlay>

        <card-img-overlay
          class="d-none d-md-block bg-blue rounded mb-n1 mx-n1"
          style="
            background-image: url(/assets/img/bg/wave-bg.png);
        ...
        <card-img-overlay class="d-none d-md-block bottom-0 top-auto">
          <div class="row">
            ...
            <div class="col-md-4 col-xl-6 mb-n2">
              <img
                src="/assets/img/page/dashboard.svg"
                alt=""
                class="d-block ms-n3 mb-5"
            ...
            <div class="col-md-8">
              ...
              <div class="row">
                <div class="col-6 col-lg-5">
                  <div class="mt-1">
                    <i
                      class="fa fa-fw fa-shopping-bag fs-28px text-black text-opacity-50"
                    ></i>
                  </div>
                  <div class="mt-1">
                    <div>Store Sales</div>
                ...
                <div class="col-6 col-lg-5">
                  <div class="mt-1">
                    <i
                      class="fa fa-fw fa-retweet fs-28px text-black text-opacity-50"
                    ></i>
                  </div>
                  <div class="mt-1">
              ...
              <div class="mt-3 mb-2">
                <a
                  ...
                  ><i class="fa fa-wallet me-2 ms-n2"></i> Withdraw money</a
                >
              </div>
              <p class="fs-12px">
                It usually takes 3-5 business days for transferring the earning
    ...
    <div class="col-xl-6">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <card
            class="mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange"
            style="min-height: 199px"
          >
            <card-img-overlay
              class="mb-n4 me-n4 d-flex"
              style="bottom: 0; top: auto"
            >
              <img
                src="/assets/img/icon/order.svg"
                alt=""
                class="ms-auto d-block mb-n3"
            ...
            <card-body class="position-relative">
              ...
              <div
                class="progress bg-black bg-opacity-50 mb-2"
                style="height: 6px"
              >
                <div
              ...
              <div class="text-white text-opacity-80 mb-4">
                <i class="fa fa-caret-up"></i> 16% increase <br />compare to
                last week
              </div>
              <div>
                <a
                  ...
                  >View report
                  <i
                    class="fa fa-chevron-right ms-2 text-white text-opacity-50"
                  ></i
                ></a>
              </div>
            </card-body>
          ...
          <card
            class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal"
            style="min-height: 199px"
          >
            <card-img-overlay
              class="card-img-overlay mb-n4 me-n4 d-flex"
              style="bottom: 0; top: auto"
            >
              <img
                src="/assets/img/icon/visitor.svg"
                alt=""
                class="ms-auto d-block mb-n3"
                style="max-height: 105px"
              />
            ...
            <card-body class="position-relative">
              ...
              <div class="text-white text-opacity-80 mb-4">
                <i class="fa fa-caret-up"></i> 33% increase <br />compare to
                last week
              </div>
              <div>
                <a
        ...
        <div class="col-sm-6">
          <card
            class="mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink"
            style="min-height: 199px"
          >
            <card-img-overlay
              class="mb-n4 me-n4 d-flex"
            ...
            <card-body class="position-relative">
              ...
              <div class="text-white text-opacity-80 mb-4">
                <i class="fa fa-caret-down"></i> 5% decrease <br />compare to
                last week
              </div>
              <div>
                <a
          ...
          <card
            class="mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
            style="min-height: 199px"
          >
            <card-img-overlay
              class="mb-n4 me-n4 d-flex"
            ...
            <card-body class="position-relative">
              ...
              <div class="text-white text-opacity-80 mb-4">
                <i class="fa fa-caret-up"></i> 20% increase <br />compare to
                last week
              </div>
              <div>
                <a
            ...
            <card-body>
              ...
              <div class="progress mb-4" style="height: 10px">
                <div
                  ...
                  style="width: 42.66%"
                ></div>
                <div class="progress-bar bg-teal" style="width: 36.8%"></div>
                <div class="progress-bar bg-yellow" style="width: 15.34%"></div>
                <div class="progress-bar bg-pink" style="width: 9.2%"></div>
                <div class="progress-bar bg-gray-200" style="width: 5%"></div>
              </div>

              <div class="fs-13px">
                <div class="d-flex align-items-center mb-2">
                  <div class="flex-grow-1 d-flex align-items-center">
                    <i class="fa fa-circle fs-9px fa-fw text-primary me-2"></i>
                    Direct visit
                  </div>
                ...
                <div class="d-flex align-items-center mb-2">
                  <div class="flex-grow-1 d-flex align-items-center">
                    <i class="fa fa-circle fs-9px fa-fw text-warning me-2"></i>
                    Referral Website
                  </div>
                ...
                <div class="d-flex align-items-center mb-2">
                  <div class="flex-grow-1 d-flex align-items-center">
                    <i class="fa fa-circle fs-9px fa-fw text-danger me-2"></i>
                    Social Networks
                  </div>
                ...
                <div class="d-flex align-items-center mb-15px">
                  <div class="flex-grow-1 d-flex align-items-center">
                    <i class="fa fa-circle fs-9px fa-fw text-gray-200 me-2"></i>
                    Others
                  </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="w-40px h-40px">
                        <img
                          src="/assets/img/icon/paypal2.svg"
                          alt=""
                          class="ms-100 mh-100"
                        />
                      </div>
                  ...
                  <td class="text-center">
                    <span
                      class="badge bg-success bg-opacity-20 text-success"
